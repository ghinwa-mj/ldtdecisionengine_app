...
with st.sidebar:
    ...
    st.markdown(
        """
        <div style="font-size: 0.9rem; color: black; background-color: #f0f0f0; padding: 10px; border-radius: 5px; line-height: 1.5;">
            <p>
                The <strong>LDT Decision Engine</strong> uses <strong>Generative AI</strong> functionalities to analyze data, provide regional and project recommendations.
            </p>
            <p>
                While we strive to ensure <strong>high-quality and accurate outputs</strong>, responses generated by the AI may occasionally contain <strong>inaccuracies, outdated information</strong>, or <strong>unintended biases</strong>.
            </p>
            <p>
                Please <strong>verify critical information independently</strong>.
            </p>
        </div>
        """,
        unsafe_allow_html=True
